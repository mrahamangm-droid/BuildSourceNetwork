  ...
  return (
    <form action={action} className="space-y-4">
      ...
      <Card className="space-y-4">
        ...
        <Field
          label="Web address"
          hint="Leave blank to build it from the title. Letters, numbers and hyphens."
          error={fe(state, "slug")}
        >
          <Input
            name="slug"
            ...
            maxLength={80}
            placeholder="how-to-compare-quotes"
          />
        </Field>
        <Field
          label="Summary"
          hint="Shown in lists and search results (20–300 characters)."
          error={fe(state, "excerpt")}
        >
          <Textarea
            name="excerpt"
            rows={2}
