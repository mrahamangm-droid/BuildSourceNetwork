...
const UNIT_ALIASES: Record<string, string> = {
  m2: "SQM", sqm: "SQM", "sq.m": "SQM", "m²": "SQM",
  m3: "CBM", cbm: "CBM", "m³": "CBM",
  m: "METER", meter: "METER", metre: "METER", lm: "METER", rm: "METER",
  kg: "KG", kgs: "KG", kilogram: "KG",
  t: "TON", ton: "TON", tons: "TON", tonne: "TON", tonnes: "TON",
  pc: "PIECE", pcs: "PIECE", piece: "PIECE", pieces: "PIECE", nos: "PIECE", no: "PIECE", each: "PIECE",
  bag: "BAG", bags: "BAG",
  box: "BOX", boxes: "BOX",
  l: "LITER", ltr: "LITER", liter: "LITER", litre: "LITER", liters: "LITER", litres: "LITER",
  roll: "ROLL", rolls: "ROLL",
  set: "SET", sets: "SET",
  pallet: "PALLET", pallets: "PALLET",
  truck: "TRUCK", trucks: "TRUCK", load: "TRUCK",
};
